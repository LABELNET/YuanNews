...
<section>
    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="logo">
            <h1><a href="index.html">新闻推荐<span>管理</span></a></h1>
        </div>
        ...
        <div class="left-side-inner">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                <li class="active"><a href="index.html"><i class="lnr lnr-power-switch"></i><span>后台统计</span></a></li>

                <li><a href="forms.html"><i class="lnr lnr-spell-check"></i> <span>用户管理</span></a></li>

                <li><a href="tables.html"><i class="lnr lnr-menu"></i> <span>新闻管理</span></a></li>

                <li class="menu-list"><a href="#"><i class="lnr lnr-envelope"></i> <span>分类与来源</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="inbox.html">来源管理</a> </li>
                        <li><a href="compose-mail.html">分类管理</a></li>
                    </ul>
                </li>

                <li class="menu-list"><a href="#"><i class="lnr lnr-indent-increase"></i> <span>兴趣管理</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="charts.html">兴趣统计</a> </li>
                    </ul>
                </li>
                <li><a href="codes.html"><i class="lnr lnr-pencil"></i> <span>评论管理</span></a></li>
                <li><a href="media.html"><i class="lnr lnr-select"></i> <span>点赞管理</span></a></li>

                <li class="menu-list"><a href="#"><i class="lnr lnr-book"></i>  <span>其他页面</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="sign-in.html">相关</a> </li>
                        <li><a href="blank_page.html">关于</a></li>
                    </ul>
                </li>
            </ul>
            <!--sidebar nav end-->
    ...
    <div class="main-content">
        ...
        <div class="header-section">
            ...
            <!--notification menu start　
             　　TODO : 消息：　用来记录最新的评论；　通知：用来记录最新的注册用户；　数据库：用来记录最新添加的新闻数量 , 统计相关最后实现
             -->
             　　
                            ...
                            <li class="dropdown profile_details_drop">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                    <div class="profile_img">
                                        <span style="background:url(images/moren.jpg)  center"> </span>
                                        <div class="user-name">
                                            <p>LABELNET<span>Administrator</span></p>
                                        </div>
                                ...
                                <ul class="dropdown-menu drp-mnu">
                                    ...
                                    <li> <a href="sign-up.html"><i class="fa fa-sign-out"></i>退出登陆</a> </li>
                                </ul>
                            </li>
                            <div class="clearfix"> </div>
                        </ul>
